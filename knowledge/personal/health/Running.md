---
title: Steve's Running Goals and Training Plan
type: note
permalink: steve/running/steves-running-goals-and-training-plan
tags:
- running
- training
- goals
...
1. **Maintain healthy, consistent running habit** - injury prevention is #1
2. **Build aerobic base** through low HR training
3. **Build distance** gradually and safely
...
- Ran slow times (10 min/mile) due to pain and conditions
- Currently rebuilding from this injury
- **Critical**: Need easy miles to rebuild hip/groin resilience

## Long-term Goals
- Marathon (potential)
- Wildwood Trail run in Portland, OR (~30 miles)

## Feedback Preferences
- Wants honest, frank advice
- Track all runs and provide feedback on HR discipline
